let projectsArray = [
    {
        ...
        description: "An App where people can rent or book any vintage vehicle of their choice for a period of time. It Utilizes React-Redux and Ruby on Rails.",
        languages: ['Bootstrap', 'Ruby', 'React', 'Rails'],
    ...
    {
      title: 'Recipe App',
      description: "This keeps track of all your recipes and ingredients. It allows you to create recipes and generate shopping list from the recipe.",
    ...
    {
      title: 'Budget App',
      description: "This is a mobile web application where you can manage your budget, you have a list of transactions associated with categories.",
      languages: ['Rails', 'Bootstrap', 'Ruby '],
    ...
    {
      title: 'Space Travel',
      description: "This Webapp provides commercial space travel services where users are allowed to book rockets and join selected space missions.",
